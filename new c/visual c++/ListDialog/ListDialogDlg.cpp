...
CListDialogDlg::CListDialogDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CListDialogDlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CListDialogDlg)
...
/////////////////////////////////////////////////////////////////////////////
// CListDialogDlg message handlers
	...
	CDialog::OnInitDialog();
     ...
     /* m_list.InsertColumn( 0, "ID", LVCFMT_LEFT, 40 );//插入列
	  ...
	  DWORD exstyle = m_cListCtrl.GetExtendedStyle();
       ...
       m_cListCtrl.InsertColumn(1, _T("Item Name"), LVCFMT_LEFT, nColInterval*3);
       m_cListCtrl.InsertColumn(2, _T("Value"), LVCFMT_LEFT, nColInterval);
       m_cListCtrl.InsertColumn(3, _T("Time"), LVCFMT_LEFT, rect.Width()-4*nColInterval);
       m_cListCtrl.InsertItem(0,"name");
       m_cListCtrl.SetItemText(0,2,"value");
       m_cListCtrl.SetItemText(0,3,"time");
